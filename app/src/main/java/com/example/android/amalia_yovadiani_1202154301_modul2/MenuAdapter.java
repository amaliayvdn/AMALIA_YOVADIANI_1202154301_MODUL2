...
public class MenuAdapter extends
    ...
    public MenuViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mItemView = mInflater.inflate(R.layout.activity_listmenu, parent, false);
    ...
    class MenuViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MenuViewHolder(final View itemView, MenuAdapter adapter) {
            super(itemView);
            foodItemView = (TextView)itemView.findViewById(R.id.detailMakanan);
            priceItemView = (TextView)itemView.findViewById(R.id.detailHarga);
            photoItemView = (ImageView)itemView.findViewById(R.id.detailFoto);
